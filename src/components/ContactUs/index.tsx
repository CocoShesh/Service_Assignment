const ContactUs = () => {
  return (
    <>
      <section className="w-full flex px-14 max-md:px-5 py-20 items-center  gap-20 h-fit max-lg:flex-col bg-contact bg-center bg-no-repeat bg-contain justify-center ">
        <section className="2xl:w-[1700px]  flex gap-10">
