...
const Plan = () => {
  return (
    <>
      <section className="flex flex-col mt-52 max-md:mt-20 justify-center items-center w-full   max-md:mx-5 px-5 2xl:w-[1650px] h-fit">
        ...
        <section className="flex justify-center items-center w-full h-[350px] max-lg:h-fit border  max-lg:flex-col-reverse max-lg:pl-0   text-black  pl-14 gap-10  rounded-lg">
          <section className="  w-full max-lg:p-5">
            ...
            <p className="text-lg text-[#525252]">
              Our marketing plan is designed to give your property the exposure
              it needs to attract the right buyers. From stunning photography to
              global syndication, we've got you covered.
            </p>
          </section>
          <img
