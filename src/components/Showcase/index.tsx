...
const Showcase = () => {
  return (
    <>
      <section className="flex flex-col w-full h-fit px-4 md:px-14 mt-10 md:mt-20 pb-10 ">
                  ...
                  <section className=" p-8 mt-5">
                    ...
                    {Array.isArray(data?.description) &&
                      data?.description.map((desc, index) => (
                        <ul
                          key={index}
                          className="list-disc mt-3 md:mt-5 pl-5 md:pl-10 2xl:text-3xl text-[#79797c]"
                        >
                          <li>{desc}</li>
                        </ul>
                      ))}
