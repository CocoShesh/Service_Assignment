      ...
      <section className="h-fit w-full  flex flex-col items-center justify-center text-center mt-10 px-4 md:px-14 mb-24 lg:mb-44">
        <section className="2xl:w-[1600px]">
          ...
          <h2 className="text-lg lg:text-xl mt-3">
            Discover How Our Expertise, Tailored Strategies, and Innovative
          ...
          <p className="text-lg 2xl:text-2xl">
            We believe that{" "}
            <span className="text-blue-500 font-semibold">transparency</span>{" "}
            and{" "}
            ...
            . We think of it before a need even arises. Because, that is just
            what we do.{" "}
